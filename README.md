# React Split Pane Window

[![NPM version](https://img.shields.io/npm/v/react-split-pane-window.svg?style=flat)](https://www.npmjs.com/package/react-split-pane-window)
![NPM license](https://img.shields.io/npm/l/react-split-pane-window.svg?style=flat)
...
This is a fork of the react-split-pane project primarily to allow the window object as a prop (to can be used in external window Portals).

## Installing

```sh
npm install react-split-pane-window

# or if you use yarn

yarn add react-split-pane-window
```
